...
// twitter info
auth.twitter_oauth = {
  consumer_key: nconf.get('YEbR3GxVIUqdQEZYQjgbVZmI4'),
  consumer_secret: nconf.get('ZoPADaXlkWYimMEm5pdVNkyAe5wwxc3ocbjsDM77zz97GAOxZG'),
  token: nconf.get('301556684-kGMtmPe2PvtCvZ1NF43AhrEOGUuoObc4I0jlxVJb'),
  token_secret: nconf.get('dM0nRQsRXlu3fuFCrAzaNTxGpAhiu2tr8r2MXYE58bZjJ')
}
auth.twitter_webhook_environment = nconf.get('Development')
...
auth.basic = httpAuth.connect(httpAuth.basic({
    ...
    callback(username == nconf.get('johnheffernan18') && password == nconf.get('Wharton1$'))
}))
